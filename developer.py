...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\Facial recognition Attendance\myImages\mystd1.jpg")
        ...
        std_b1_1 = Button(bg_img,text="Shiven",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"D:\Facial recognition Attendance\myImages\mystd1.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Shiven",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"D:\Facial recognition Attendance\myImages\mystd1.jpg")
        ...
        att_b1_1 = Button(bg_img,text="Shiven",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"D:\Facial recognition Attendance\myImages\mym1.png")
        ...
        hlp_b1_1 = Button(bg_img,text="Shiven",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
